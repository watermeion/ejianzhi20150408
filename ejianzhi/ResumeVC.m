...
- (void)previewResume{
    ...
    previewVC.type=0;
    previewVC.userImageArray=(NSMutableArray*)[[userImages reverseObjectEnumerator] allObjects];
...
- (IBAction)addPicAction:(UIButton *)sender {
    if ([addedPicArray count]<5) {
        ...
        UIAlertView *alert=[[UIAlertView alloc]initWithTitle:@"您最多只能添加5张照片" message:nil delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil, nil];
        [alert show];
    }
}
